    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4">
        <div class="features-item">
          <h3>Tahu Walik</h3>
          <img src="<?php echo base_url('assets/img/specials/4.jpg') ?>" class="img-responsive" alt="">
      ...
      <div class="col-xs-12 col-sm-4">
        <div class="features-item">
          ...
          <img src="<?php echo base_url('assets/img/specials/5.jpg') ?>" class="img-responsive" alt="">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sed commodo.</p>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="<?php echo base_url('assets/img/gallery/01.jpg') ?>" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="<?php echo base_url('assets/img/gallery/02.jpg') ?>" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="<?php echo base_url('assets/img/gallery/03.jpg') ?>" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="<?php echo base_url('assets/img/gallery/04.jpg') ?>" class="img-responsive" alt=""></div>
      </div>
    </div>
  </div>
</div> -->
...
<div id="team">
  <div class="container">
    <div id="row">
      ...
      <div class="col-md-6">
        <div class="team-img"><img src="<?php echo base_url('assets/img/1.jpg') ?>" alt="..."></div>
      </div>
    </div>
  </div>
</div>
